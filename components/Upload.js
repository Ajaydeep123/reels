...
function Upload({ userData }) {
  ...
  return (
    <div className="upload-btn">
      ...
      {/* agar error empty string na ho, i.e, if there exist an error then render the Alert component otherwise render the Button component  */}
        {error != ""?(
      ...
      {/* if loading is happening, i.e, if loading is true then only render LinearProgress component */}
      {loading &&(
        <LinearProgress
          color="secondary"
          variant="determinate"
